...
class SystemMetricsCollector:
    def __init__(self):
        self.system_name = "lipid-nanoparticle-mrna-agent"
        self.tasks_total = 0
    ...
    def export_prometheus_text(self) -> str:
        ...
        p_lines = [
            ...
            "",
            "# HELP system_tasks_by_urgency_total Total count of tasks by urgency classification",
            "# TYPE system_tasks_by_urgency_total counter",
            f'system_tasks_by_urgency_total{{system="{sys_lbl}",urgency="CRITICAL_STAT"}} {self.critical_alerts_total}',
            f'system_tasks_by_urgency_total{{system="{sys_lbl}",urgency="ELEVATED_RISK"}} {self.elevated_alerts_total}',
            f'system_tasks_by_urgency_total{{system="{sys_lbl}",urgency="ROUTINE"}} {self.routine_tasks_total}',
            "",
