"""
Data Models & Telemetry Definitions for LNP-Formulator: Ionizable Lipid pKa & mRNA Encapsulation Efficiency Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Lipid Nanoparticle (LNP) Quality Metrics"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
