"""
FastAPI REST API Server for LNP-Formulator: Ionizable Lipid pKa & mRNA Encapsulation Efficiency Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="LNP-Formulator: Ionizable Lipid pKa & mRNA Encapsulation Efficiency Agent",
            description="Calculates N/P ratios (amine to phosphate), apparent pKa (TNS fluorescence modeling), particle polydispersity index (PDI), and mRNA encapsulation %.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "lipid-nanoparticle-mrna-agent", "domain": "Computational Chemistry & AI Drug Discovery", "version": "2.0.0-FRONTIER"}
